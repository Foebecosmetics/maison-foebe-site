...
(function () {
  ...
  var SHELL_CSS = [
    ...
    "#foebeBreadcrumb nav{max-width:1040px!important;margin:0 auto!important;padding:10px clamp(16px,3vw,28px)!important;display:flex!important;align-items:center!important;flex-wrap:wrap!important;gap:4px 6px!important;}",
    "#foebeBreadcrumb ol{list-style:none!important;display:flex!important;flex-wrap:wrap!important;align-items:center!important;gap:4px 6px!important;margin:0!important;padding:0!important;}",
    "#foebeBreadcrumb li{display:flex!important;align-items:center!important;gap:6px!important;font-family:'Poppins',sans-serif!important;font-size:11.5px!important;font-weight:500!important;line-height:1.2!important;}",
    "#foebeBreadcrumb li+li::before{content:'›'!important;color:var(--warm,#BB7E60)!important;opacity:.74!important;font-size:12px!important;line-height:1!important;}",
    "#foebeBreadcrumb a{color:var(--warm,#BB7E60)!important;text-decoration:none!important;opacity:.82!important;transition:opacity .18s ease!important;}",
    ...
    "#foebeBreadcrumb [aria-current='page']{color:var(--text,#F0EAE7)!important;opacity:.92!important;font-weight:600!important;}",
    "[data-theme='day'] #foebeBreadcrumb [aria-current='page']{color:#4E291F!important;}",
    "[data-theme='day'] #foebeBreadcrumb a{color:#BB7E60!important;}",
    "@media(max-width:640px){#foebeBreadcrumb{padding-top:66px!important;}#foebeBreadcrumb nav{padding:8px clamp(14px,4vw,20px)!important;}#foebeBreadcrumb li{font-size:11px!important;}}",
  ...
  /* ═══════════════════════════════════════════════════════════════════════════
     2.5 FIL D’ARIANE — navigation contextuelle
  ═══════════════════════════════════════════════════════════════════════════ */
  var BREADCRUMB_MAP = {
    "index.html": null,
    "comprendre.html":             [{ label: "Accueil", href: "index.html" }, { label: "Comprendre" }],
    "a-propos.html":               [{ label: "Accueil", href: "index.html" }, { label: "À propos" }],
    "methode.html":                [{ label: "Accueil", href: "index.html" }, { label: "La méthode Foébé" }],
    "pratiquer.html":              [{ label: "Accueil", href: "index.html" }, { label: "Pratiquer" }],
    "test.html":                   [{ label: "Accueil", href: "index.html" }, { label: "Pratiquer", href: "pratiquer.html" }, { label: "Échelle Foébé" }],
    "foebe-zones-cadre.html":      [{ label: "Accueil", href: "index.html" }, { label: "Pratiquer", href: "pratiquer.html" }, { label: "Les 7 zones" }],
    "respiration.html":            [{ label: "Accueil", href: "index.html" }, { label: "Pratiquer", href: "pratiquer.html" }, { label: "Respiration guidée" }],
    "boussole-accueil-foebe.html": [{ label: "Accueil", href: "index.html" }, { label: "Pratiquer", href: "pratiquer.html" }, { label: "Sas de la Boussole" }],
    "boussole.html":               [{ label: "Accueil", href: "index.html" }, { label: "Pratiquer", href: "pratiquer.html" }, { label: "Sas", href: "boussole-accueil-foebe.html" }, { label: "La Boussole" }],
    "zone-corps.html":             [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Corps" }],
    "zone-mental.html":            [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Mental" }],
    "zone-energie.html":           [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Énergie" }],
    "zone-emotions.html":          [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Émotions" }],
    "zone-environnement.html":     [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Environnement" }],
    "zone-relations.html":         [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Relations" }],
    "zone-sens.html":              [{ label: "Accueil", href: "index.html" }, { label: "7 zones", href: "foebe-zones-cadre.html" }, { label: "Sens" }],
    "stories.html":                [{ label: "Accueil", href: "index.html" }, { label: "Ressources" }, { label: "Lexique Foébé" }],
    "dictionnaire.html":           [{ label: "Accueil", href: "index.html" }, { label: "Ressources" }, { label: "Dictionnaire Foébé" }]
  };
  ...
  function injectBreadcrumb() {
    ...
    var ol = crumbs.map(function (crumb, index) {
      var isLast = index === crumbs.length - 1;
      var label = escapeShellText(crumb.label);
      if (isLast || !crumb.href) {
        return '<li><span aria-current="page">' + label + '</span></li>';
      }
      return '<li><a href="' + escapeShellText(crumb.href) + '">' + label + '</a></li>';
    }).join("");

    var breadcrumb = document.createElement("div");
    breadcrumb.id = "foebeBreadcrumb";
    breadcrumb.innerHTML = '<nav aria-label="Fil d’Ariane"><ol>' + ol + '</ol></nav>';
