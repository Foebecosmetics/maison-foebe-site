...
(function () {
  ...
  (function injectFoebeBreadcrumbFast() {
    ...
    function injectCss() {
      ...
      var css = [
        ".foebe-breadcrumb{width:min(100%,1040px);max-width:1040px;margin:0 auto!important;padding:0 clamp(20px,4vw,40px)!important;font-family:'Poppins',sans-serif;font-size:12.5px;line-height:1.45;color:#F0EAE7;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;}",
        ...
        ".foebe-breadcrumb-home{display:inline-flex;align-items:center;justify-content:center;min-height:32px;padding:6px 11px;border-radius:999px;background:#BB7E60!important;color:#F0EAE7!important;border:1px solid #BB7E60!important;font-weight:800;box-shadow:0 8px 18px rgba(187,126,96,.16);}",
        ...
        ".foebe-breadcrumb--before-hero{margin-top:calc(60px + clamp(26px,4.5svh,52px))!important;margin-bottom:clamp(22px,4svh,44px)!important;}",
        ".foebe-breadcrumb--zone{max-width:980px;margin-bottom:clamp(30px,5svh,60px)!important;}",
        "@media(max-width:640px){.foebe-breadcrumb{width:100%;max-width:100%;font-size:11.4px;padding:0 20px!important;}.foebe-breadcrumb--before-hero{margin-top:calc(58px + 24px)!important;margin-bottom:28px!important;}.foebe-breadcrumb ol{gap:5px;}.foebe-breadcrumb li{gap:5px;}.foebe-breadcrumb-home{min-height:31px;padding:6px 10px;}.foebe-breadcrumb-link{text-underline-offset:4px!important;text-decoration-thickness:1.5px!important;}}",
    ...
    nav.className = "foebe-breadcrumb foebe-breadcrumb--before-hero" + (isZonePage ? " foebe-breadcrumb--zone" : "");
    ...
    /* Placement unique et prévisible : toujours avant le hero.
       Ainsi Comprendre, 7 zones, Respiration, Dictionnaire, etc.
       partagent le même repère sous la nav fixe. */
