...
if (countOccurrences(shellScript, '/cadre-editorial/') < 2) {
  errors.push('Shell : le lien Cadre éditorial doit être présent dans la navigation et le footer');
}
...
console.log(`\n✅ Audit Phases A + B + C + D1 réussi : ${pageFiles.length} pages HTML, ${indexableRoutes.size} pages indexables, zéro incohérence bloquante.`);
