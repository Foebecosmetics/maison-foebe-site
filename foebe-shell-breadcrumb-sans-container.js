...
(function () {
  ...
  (function injectFoebeBreadcrumbFast() {
    ...
    function injectCss() {
      ...
      var css = [
        ".foebe-breadcrumb{width:min(100%,860px);margin:0 0 clamp(18px,3svh,28px);padding:0;font-family:'Poppins',sans-serif;font-size:12.5px;line-height:1.45;color:#F0EAE7;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;}",
        ...
        ".foebe-breadcrumb li:not(:last-child)::after{content:'›';color:#BB7E60;opacity:.88;font-weight:800;}",
        ...
        ".foebe-breadcrumb-home{display:inline-flex;align-items:center;justify-content:center;min-height:30px;padding:5px 10px;border-radius:999px;background:#BB7E60!important;color:#F0EAE7!important;border:1px solid #BB7E60!important;font-weight:800;box-shadow:0 8px 18px rgba(187,126,96,.18);}",
        ...
        ".foebe-breadcrumb-link{font-weight:700;text-decoration:underline;text-decoration-color:rgba(187,126,96,.70);text-decoration-thickness:1px;text-underline-offset:4px;}",
        ...
        ".foebe-breadcrumb-section{opacity:.82;font-weight:600;}",
        ...
        "@media(max-width:520px){.foebe-breadcrumb{width:100%;max-width:100%;font-size:11.4px;margin-bottom:18px;}.foebe-breadcrumb ol{gap:5px;}.foebe-breadcrumb li{gap:5px;}.foebe-breadcrumb-home{min-height:30px;padding:5px 9px;}.foebe-breadcrumb-link{text-underline-offset:3px;}}",
